/* eslint-disable */
// Generated by Wrangler by running `wrangler types shared/wrangler.d.ts` (hash: b906bbb64cf8bf7b58a042496b6fb28b)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NUXT_FILES_AWS_BUCKET: string;
		NUXT_FILES_AWS_ENDPOINT: string;
		NUXT_FILES_AWS_ACCESS_KEY_ID: string;
		NUXT_FILES_AWS_SECRET_ACCESS_KEY: string;
		NUXT_FILES_AWS_REGION: string;
		FILES: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
	}

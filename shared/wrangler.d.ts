/* eslint-disable */
// Generated by Wrangler by running `wrangler types shared/wrangler.d.ts` (hash: 33e45dd81e96906040dc76eaa37da411)
// Runtime types generated with workerd@1.20260918.1 2026-09-20 global_fetch_strictly_public,nodejs_compat_v2
interface __BaseEnv_Env {
	...
	NUXT_FILES_BUCKET: string;
	NUXT_FILES_ENDPOINT: string;
	NUXT_FILES_ACCESS_KEY_ID: string;
	NUXT_FILES_SECRET_ACCESS_KEY: string;
	NUXT_FILES_REGION: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "NUXT_FILES_BUCKET" | "NUXT_FILES_ENDPOINT" | "NUXT_FILES_ACCESS_KEY_ID" | "NUXT_FILES_SECRET_ACCESS_KEY" | "NUXT_FILES_REGION">> {}
}
